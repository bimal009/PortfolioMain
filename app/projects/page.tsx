...
import { ExternalLink, Filter, Code, Layout, Calendar, Tag, Briefcase, User, Bot, ShoppingCart, Globe, Palette, Database, Shield, Search, Users, Trophy, MessageCircle, Smartphone, Monitor, Zap, Settings, Star, ChevronRight, Github, Linkedin } from "lucide-react";
    ...
    const projects = [
        {
            ...
            features: [
                { icon: Calendar, text: "Event booking system with calendar integration" },
                { icon: Globe, text: "Venue selection and reservation functionality" },
                { icon: ShoppingCart, text: "Equipment rental with availability tracking" },
        ...
        },
        {
            ...
            technologies: ["Next.js", "Tailwind CSS", "Google Gemini API", "Twitter API", "Express.js", "Serverless Functions", "REST API"],
            features: [
                { icon: Bot, text: "Automated tweet generation using Google Gemini AI" },
        ...
        },
        {
            ...
            features: [
                { icon: Search, text: "Dynamic product listing with search and filters" },
                { icon: ShoppingCart, text: "Shopping cart with state persistence" },
                { icon: Shield, text: "User authentication and order history" },
                { icon: Settings, text: "Admin panel for product and order management" },
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 sm:mb-10 lg:mb-12 text-center px-2 sm:px-0">
                    <div className="flex items-center justify-center mb-3 sm:mb-4">
                        ...
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white">My Projects</h1>
                        <Code size={24} className="sm:size-8 text-purple-400 ml-3 scale-x-[-1]" />
                    </div>
                    ...
                    <div className="card-gradient p-1 sm:p-2 rounded-lg border border-white/5 shadow-md">
                        <div className="flex flex-wrap justify-center gap-1 sm:gap-2">
                            <button
                                ...
                                className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-md transition-all duration-300 flex items-center text-xs sm:text-sm ${filter === "all" ? "bg-purple-600 text-white" : "hover:bg-gray-800"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-md transition-all duration-300 flex items-center text-xs sm:text-sm ${filter === "freelance" ? "bg-purple-600 text-white" : "hover:bg-gray-800"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-md transition-all duration-300 flex items-center text-xs sm:text-sm ${filter === "personal" ? "bg-purple-600 text-white" : "hover:bg-gray-800"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-md transition-all duration-300 flex items-center text-xs sm:text-sm ${filter === "ai" ? "bg-purple-600 text-white" : "hover:bg-gray-800"
                                    }`}
                            >
                    ...
                    {filteredProjects.map((project) => (
                        ...
                        >
                            ...
                            <div className="p-5 sm:p-6 lg:p-8 flex-grow">
                                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-4 mb-4">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2.5 bg-purple-900/30 rounded-lg">
                                            <project.projectIcon size={18} className="text-purple-400" />
                                        </div>
                                ...
                                <p className="text-sm sm:text-base text-gray-400 mb-6 leading-relaxed">{project.description}</p>
                ...
                {filteredProjects.length === 0 && (
                    <div className="text-center py-16 sm:py-20 px-4">
                        <Filter size={32} className="sm:size-48 mx-auto text-gray-600 mb-3 sm:mb-4" />
                        <h3 className="text-lg sm:text-xl font-bold text-white mb-2">No projects found</h3>
                        <p className="text-sm sm:text-base text-gray-400">Try changing your filter criteria</p>
                    </div>
                )}
